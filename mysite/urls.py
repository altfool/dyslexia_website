...
import mezzanine.pages.views as mezzanine_pages_views
...
urlpatterns += [
    ...
    # url(r'^accts/', include('registration.backends.default.urls')),
    url("^$", mezzanine_pages_views.page, {"slug": "/"}, name="home"),
